...
Revision ID: 007_tender_knowledge
...
revision: str = "007_tender_knowledge"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("bundling_parents", postgresql.ARRAY(sa.Text()), nullable=False),
        sa.Column("region_tags", postgresql.ARRAY(sa.Text()), nullable=False),
        sa.Column("build_type_tags", postgresql.ARRAY(sa.Text()), nullable=False),
    ...
    op.create_index("ix_benchmarks_benchmark_key", "benchmarks", ["benchmark_key"])
