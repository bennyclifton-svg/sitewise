...
intent. Detailed design documents provide supporting facts only and must not make
one discipline dominate a whole-of-project Main Works tender.
...
- Requested services: provide 5–8 concise, one-line scope and interface items. Use
  ...
  are applicable. For Main Works, keep each item at whole-of-project contractor
  level and group detailed services as multidisciplinary coordination. Cite every
  project-specific item with its exact [n] token.
