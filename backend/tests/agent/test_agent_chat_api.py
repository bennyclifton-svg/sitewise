...
def test_agent_stream_persists_user_then_successful_assistant_message(
    ...
    expected_prompt = (
        ...
        "workflow.approved_tender_cost_handoff=needs_input; required_fields=building_class,work_type,state; reasons=Cost Plan requires confirmed project context.\n"
        ...
        "workflow.create_cost_plan=needs_input; required_fields=building_class,work_type,state; reasons=Cost Plan requires confirmed project context.\n"
        ...
        "workflow.edit_cost_plan=needs_input; required_fields=building_class,work_type,state; reasons=Cost Plan requires confirmed project context.\n"
        "workflow.refresh_cost_plan=needs_input; required_fields=building_class,work_type,state; reasons=Cost Plan requires confirmed project context.\n"
