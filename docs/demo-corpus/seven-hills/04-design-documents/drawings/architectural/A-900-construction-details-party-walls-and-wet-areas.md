# A-900 — Construction Details — Party Walls and Wet Areas

> **Synthetic demo artefact.** No real site, company, person or identifier is represented.

**Architectural drawing · Axis Studio**
...
| Drawing title | Construction Details — Party Walls and Wet Areas |
| Drawing number | **A-900** |
| Revision | **D** |
...
**Axis Studio**  
Level 2, 17 Foundry Road, Parramatta NSW 2150

## Revision history

| Rev | Date | Description |
| :---: | --- | --- |
| D | 2026-01-30 | For Construction |
...
© Axis Studio — synthetic demonstration record only.
