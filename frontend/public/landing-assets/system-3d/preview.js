...
var Wr = {
	...
	setMorphAt(e, t) {
		...
		this.morphTexture === null && (this.morphTexture = new Si(new Float32Array(r * this.count), r, this.count, k, v));
...
var Sa = class {
	...
	constructor(e, t, n, r) {
		...
		this.name = e, this.times = _a(t, this.TimeBufferType), this.values = _a(n, this.ValueBufferType), this.setInterpolation(r || this.DefaultInterpolation);
	}
	static toJSON(e) {
	...
	validate() {
		...
		if (r !== void 0 && va(r)) for (let t = 0, n = r.length; t !== n; ++t) {
			let n = r[t];
			if (isNaN(n)) {
...
Ea.prototype.ValueTypeName = "", Ea.prototype.TimeBufferType = Float32Array, Ea.prototype.ValueBufferType = Float32Array, Ea.prototype.DefaultInterpolation = De;
var Da = class extends Ea {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
Da.prototype.ValueTypeName = "bool", Da.prototype.ValueBufferType = Array, Da.prototype.DefaultInterpolation = Ee, Da.prototype.InterpolantFactoryMethodLinear = void 0, Da.prototype.InterpolantFactoryMethodSmooth = void 0;
...
var Ma = class extends Ea {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
Ma.prototype.ValueTypeName = "string", Ma.prototype.ValueBufferType = Array, Ma.prototype.DefaultInterpolation = Ee, Ma.prototype.InterpolantFactoryMethodLinear = void 0, Ma.prototype.InterpolantFactoryMethodSmooth = void 0;
...
var Pa = class {
	...
	static parse(e) {
		...
		for (let e = 0, i = n.length; e !== i; ++e) t.push(Ia(n[e]).scale(r));
	...
	static toJSON(e) {
		...
		for (let e = 0, r = n.length; e !== r; ++e) t.push(Ea.toJSON(n[e]));
		return r;
	}
	static CreateFromMorphTargetSequence(e, t, n, r) {
		...
		for (let e = 0; e < i; e++) {
			...
			let c = ya(o);
			o = ba(o, 1, c), s = ba(s, 1, c), !r && o[0] === 0 && (o.push(i), s.push(s[0])), a.push(new ka(".morphTargetInfluences[" + t[e].name + "]", o, s).scale(1 / n));
		}
	...
	static parseAnimation(e, t) {
		...
		let n = function(e, t, n, r, i) {
			if (n.length !== 0) {
				let a = [], o = [];
				xa(n, a, o, r), a.length !== 0 && i.push(new e(t, a, o));
			}
		...
		for (let e = 0; e < c.length; e++) {
			...
			if (!(!i || i.length === 0)) if (i[0].morphTargets) {
				...
				for (let n in e) {
					...
					r.push(new ka(".morphTargetInfluence[" + n + "]", e, a));
				}
				s = e.length * a;
			} else {
				let a = ".bones[" + t[e].name + "]";
				n(Na, a + ".position", i, "pos", r), n(ja, a + ".quaternion", i, "rot", r), n(Na, a + ".scale", i, "scl", r);
			}
		}
...
function Fa(e) {
	switch (e.toLowerCase()) {
		...
		case "float":
		case "number":
		case "integer": return ka;
		case "vector":
		case "vector2":
		case "vector3":
		case "vector4": return Na;
		case "color": return Oa;
		case "quaternion": return ja;
		case "bool":
		case "boolean": return Da;
		case "string": return Ma;
	}
...
function Ia(e) {
	...
	if (e.times === void 0) {
		let t = [], n = [];
		xa(e.keys, t, n, "value"), e.times = t, e.values = n;
	}
...
var La = {
	...
	constructor(e) {
		this.manager = e === void 0 ? Ra : e, this.crossOrigin = "anonymous", this.withCredentials = !1, this.path = "", this.resourcePath = "", this.requestHeader = {};
	}
	load() {}
	loadAsync(e, t) {
		let n = this;
...
var Ba = {}, Va = class extends Error {
	...
	load(e, t, n, r) {
		...
		fetch(a).then((t) => {
			if (t.status === 200 || t.status === 0) {
				...
				let n = Ba[e], r = t.body.getReader(), i = t.headers.get("X-File-Size") || t.headers.get("Content-Length"), a = i ? parseInt(i) : 0, o = a !== 0, s = 0, c = new ReadableStream({ start(e) {
					t();
					function t() {
			...
			} else throw new Va(`fetch for "${t.url}" responded with ${t.status}: ${t.statusText}`, t);
		}).then((e) => {
			switch (s) {
...
}, Ua = /* @__PURE__ */ new WeakMap(), Wa = class extends za {
	constructor(e) {
		super(e);
	}
	load(e, t, n, r) {
		this.path !== void 0 && (e = this.path + e), e = this.manager.resolveURL(e);
		let i = this, a = La.get(`image:${e}`);
		if (a !== void 0) {
		...
		return o.addEventListener("load", s, !1), o.addEventListener("error", c, !1), e.slice(0, 5) !== "data:" && this.crossOrigin !== void 0 && (o.crossOrigin = this.crossOrigin), La.add(`image:${e}`, o), i.manager.itemStart(e), o.src = e, o;
	}
}, Ga = class extends za {
	constructor(e) {
		super(e);
	...
	load(e, t, n, r) {
		let i = new It(), a = new Wa(this.manager);
...
}, Ja = /*@__PURE__*/ new J(), Ya = /*@__PURE__*/ new W(), Xa = /*@__PURE__*/ new W(), Za = class {
	constructor(e) {
	...
	updateMatrices(e) {
		...
		Ya.setFromMatrixPosition(e.matrixWorld), t.position.copy(Ya), Xa.setFromMatrixPosition(e.target.matrixWorld), t.lookAt(Xa), t.updateMatrixWorld(), Ja.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), this._frustum.setFromProjectionMatrix(Ja, t.coordinateSystem, t.reversedDepth), t.reversedDepth ? n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, 1, 0, 0, 0, 0, 1) : n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, .5, .5, 0, 0, 0, 1), n.multiply(Ja);
	}
	getViewport(e) {
	...
	constructor(e, t, n = 0, r = Math.PI / 3, i = 0, a = 2) {
		super(e, t), this.isSpotLight = !0, this.type = "SpotLight", this.position.copy(Vn.DEFAULT_UP), this.updateMatrix(), this.target = new Vn(), this.distance = n, this.angle = r, this.penumbra = i, this.decay = a, this.map = null, this.shadow = new Qa();
	}
	get power() {
...
}, eo = /*@__PURE__*/ new J(), to = /*@__PURE__*/ new W(), no = /*@__PURE__*/ new W(), ro = class extends Za {
	constructor() {
	...
	updateMatrices(e, t = 0) {
		...
		i !== n.far && (n.far = i, n.updateProjectionMatrix()), to.setFromMatrixPosition(e.matrixWorld), n.position.copy(to), no.copy(n.position), no.add(this._cubeDirections[t]), n.up.copy(this._cubeUps[t]), n.lookAt(no), n.updateMatrixWorld(), r.makeTranslation(-to.x, -to.y, -to.z), eo.multiplyMatrices(n.projectionMatrix, n.matrixWorldInverse), this._frustum.setFromProjectionMatrix(eo, n.coordinateSystem, n.reversedDepth);
	}
}, io = class extends Ka {
	constructor(e, t, n = 0, r = 2) {
		super(e, t), this.isPointLight = !0, this.type = "PointLight", this.distance = n, this.decay = r, this.shadow = new ro();
	}
	get power() {
	...
	constructor() {
		super(new ao(-5, 5, 5, -5, .5, 500)), this.isDirectionalLightShadow = !0;
	}
}, so = class extends Ka {
	constructor(e, t) {
		super(e, t), this.isDirectionalLight = !0, this.type = "DirectionalLight", this.position.copy(Vn.DEFAULT_UP), this.updateMatrix(), this.target = new Vn(), this.shadow = new oo();
	}
	dispose() {
		this.shadow.dispose();
	}
...
}, lo = /* @__PURE__ */ new WeakMap(), uo = class extends za {
	constructor(e) {
	...
	load(e, t, n, r) {
		e === void 0 && (e = ""), this.path !== void 0 && (e = this.path + e), e = this.manager.resolveURL(e);
		let i = this, a = La.get(`image-bitmap:${e}`);
		if (a !== void 0) {
		...
		let s = fetch(e, o).then(function(e) {
			...
			return La.add(`image-bitmap:${e}`, n), t && t(n), i.manager.itemEnd(e), n;
		}).catch(function(t) {
			r && r(t), lo.set(s, t), La.remove(`image-bitmap:${e}`), i.manager.itemError(e), i.manager.itemEnd(e);
		});
		La.add(`image-bitmap:${e}`, s), i.manager.itemStart(e);
	}
	abort() {
		return this._abortController.abort(), this._abortController = new AbortController(), this;
	}
...
}, po = "\\[\\]\\.:\\/", mo = /* @__PURE__ */ RegExp("[\\[\\]\\.:\\/]", "g"), ho = "[^\\[\\]\\.:\\/]", go = "[^" + po.replace("\\.", "") + "]", _o = /*@__PURE__*/ "((?:WC+[\\/:])*)".replace("WC", ho), vo = /*@__PURE__*/ "(WCOD+)?".replace("WCOD", go), yo = /*@__PURE__*/ "(?:\\.(WC+)(?:\\[(.+)\\])?)?".replace("WC", ho), bo = /*@__PURE__*/ "\\.(WC+)(?:\\[(.+)\\])?".replace("WC", ho), xo = RegExp("^" + _o + vo + yo + bo + "$"), So = [
	"material",
	"materials",
	"bones",
	"map"
	...
	static parseTrackName(e) {
		...
		if (r !== void 0 && r !== -1) {
			...
			So.indexOf(e) !== -1 && (n.nodeName = n.nodeName.substring(0, r), n.objectName = e);
		}
...
wo.Composite = Co, wo.prototype.BindingType = {
	Direct: 0,
	EntireArray: 1,
	ArrayElement: 2,
	HasFromToArray: 3
}, wo.prototype.Versioning = {
	None: 0,
	NeedsUpdate: 1,
	MatrixWorldNeedsUpdate: 2
}, wo.prototype.GetterByBindingType = [
	wo.prototype._getValue_direct,
	wo.prototype._getValue_array,
	wo.prototype._getValue_arrayElement,
	wo.prototype._getValue_toArray
], wo.prototype.SetterByBindingTypeAndVersioning = [
	[
		wo.prototype._setValue_direct,
		wo.prototype._setValue_direct_setNeedsUpdate,
		wo.prototype._setValue_direct_setMatrixWorldNeedsUpdate
	],
	[
		wo.prototype._setValue_array,
		wo.prototype._setValue_array_setNeedsUpdate,
		wo.prototype._setValue_array_setMatrixWorldNeedsUpdate
	],
	[
		wo.prototype._setValue_arrayElement,
		wo.prototype._setValue_arrayElement_setNeedsUpdate,
		wo.prototype._setValue_arrayElement_setMatrixWorldNeedsUpdate
	],
	[
		wo.prototype._setValue_fromArray,
		wo.prototype._setValue_fromArray_setNeedsUpdate,
		wo.prototype._setValue_fromArray_setMatrixWorldNeedsUpdate
	]
];
var To = class {
...
jo.physical = {
	uniforms: /*@__PURE__*/ Vr([jo.standard.uniforms, {
		clearcoat: { value: 0 },
...
var Mo = {
	...
	b: 0,
	g: 0
}, No = /*@__PURE__*/ new wn(), Po = /*@__PURE__*/ new J();
function Fo(e, t, n, r, i, a, o) {
	...
	function g(t, n) {
		...
		r && (r.isCubeTexture || r.mapping === 306) ? (u === void 0 && (u = new Ir(new zr(1, 1, 1), new qr({
			...
			uniforms: Br(jo.backgroundCube.uniforms),
		...
		} }), i.update(u)), No.copy(n.backgroundRotation), No.x *= -1, No.y *= -1, No.z *= -1, r.isCubeTexture && r.isRenderTargetTexture === !1 && (No.y *= -1, No.z *= -1), u.material.uniforms.envMap.value = r, u.material.uniforms.flipEnvMap.value = r.isCubeTexture && r.isRenderTargetTexture === !1 ? -1 : 1, u.material.uniforms.backgroundBlurriness.value = n.backgroundBlurriness, u.material.uniforms.backgroundIntensity.value = n.backgroundIntensity, u.material.uniforms.backgroundRotation.value.setFromMatrix4(Po.makeRotationFromEuler(No)), u.material.toneMapped = K.getTransfer(r.colorSpace) !== Re, (d !== r || f !== r.version || p !== e.toneMapping) && (u.material.needsUpdate = !0, d = r, f = r.version, p = e.toneMapping), u.layers.enableAll(), t.unshift(u, u.geometry, u.material, 0, 0, null)) : r && r.isTexture && (l === void 0 && (l = new Ir(new fa(2, 2), new qr({
			name: "BackgroundMaterial",
			uniforms: Br(jo.background.uniforms),
	...
	function _(t, n) {
		t.getRGB(Mo, Ur(e)), r.buffers.color.setClear(Mo.r, Mo.g, Mo.b, n, o);
	}
	function v() {
...
var Vo = 4, Ho = [
	...
	.526,
	.582
], Uo = 20, Wo = /*@__PURE__*/ new ao(), Go = /*@__PURE__*/ new Y(), Ko = null, qo = 0, Jo = 0, Yo = !1, Xo = (1 + Math.sqrt(5)) / 2, Zo = 1 / Xo, Qo = [
	/*@__PURE__*/ new W(-Xo, Zo, 0),
	/*@__PURE__*/ new W(Xo, Zo, 0),
	/*@__PURE__*/ new W(-Zo, 0, Xo),
	/*@__PURE__*/ new W(Zo, 0, Xo),
	/*@__PURE__*/ new W(0, Xo, -Zo),
	/*@__PURE__*/ new W(0, Xo, Zo),
	/*@__PURE__*/ new W(-1, 1, -1),
	/*@__PURE__*/ new W(1, 1, -1),
	/*@__PURE__*/ new W(-1, 1, 1),
	/*@__PURE__*/ new W(1, 1, 1)
], $o = /*@__PURE__*/ new W(), es = class {
	constructor(e) {
		this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._lodPlanes = [], this._sizeLods = [], this._sigmas = [], this._blurMaterial = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._compileMaterial(this._blurMaterial);
	}
	fromScene(e, t = 0, n = .1, r = 100, i = {}) {
		let { size: a = 256, position: o = $o } = i;
		Ko = this._renderer.getRenderTarget(), qo = this._renderer.getActiveCubeFace(), Jo = this._renderer.getActiveMipmapLevel(), Yo = this._renderer.xr.enabled, this._renderer.xr.enabled = !1, this._setSize(a);
	...
	_cleanup(e) {
		this._renderer.setRenderTarget(Ko, qo, Jo), this._renderer.xr.enabled = Yo, e.scissorTest = !1, rs(e, 0, 0, e.width, e.height);
	}
	_fromTexture(e, t) {
		e.mapping === 301 || e.mapping === 302 ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), Ko = this._renderer.getRenderTarget(), qo = this._renderer.getActiveCubeFace(), Jo = this._renderer.getActiveMipmapLevel(), Yo = this._renderer.xr.enabled, this._renderer.xr.enabled = !1;
	...
	_allocateTargets() {
		...
		if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
			...
			let { _lodMax: r } = this;
			({sizeLods: this._sizeLods, lodPlanes: this._lodPlanes, sigmas: this._sigmas} = ts(r)), this._blurMaterial = is(r, e, t);
		}
		return r;
	}
	_compileMaterial(e) {
	...
	_sceneToCubeUV(e, t, n, r, i) {
		...
		c.getClearColor(Go), c.toneMapping = 0, c.autoClear = !1, c.state.buffers.depth.getReversed() && (c.setRenderTarget(r), c.clearDepth(), c.setRenderTarget(null));
		let d = new lr({
		...
		m ? m.isColor && (d.color.copy(m), e.background = null, p = !0) : (d.color.copy(Go), p = !0);
		for (let t = 0; t < 6; t++) {
			let n = t % 3;
			...
			rs(r, n * l, t > 2 ? l : 0, l, l), c.setRenderTarget(r), p && c.render(f, a), c.render(e, a);
		}
	...
	_textureToCubeUV(e, t) {
		...
		rs(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, Wo);
	}
	_applyPMREM(e) {
		...
		for (let t = 1; t < r; t++) {
			let n = Math.sqrt(this._sigmas[t] * this._sigmas[t] - this._sigmas[t - 1] * this._sigmas[t - 1]), i = Qo[(r - t - 1) % Qo.length];
	...
	_halfBlur(e, t, n, r, i, a, o) {
		...
		let l = new Ir(this._lodPlanes[r], c), u = c.uniforms, d = this._sizeLods[n] - 1, f = isFinite(i) ? Math.PI / (2 * d) : 2 * Math.PI / (2 * Uo - 1), p = i / f, m = isFinite(i) ? 1 + Math.floor(3 * p) : Uo;
		m > Uo && console.warn(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${Uo}`);
		let h = [], g = 0;
		for (let e = 0; e < Uo; ++e) {
		...
		rs(t, 3 * v * (r > _ - Vo ? r - _ + Vo : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v), s.setRenderTarget(t), s.render(l, Wo);
	}
};
function ts(e) {
	let t = [], n = [], r = [], i = e, a = e - Vo + 1 + Ho.length;
	for (let o = 0; o < a; o++) {
		let a = 2 ** i;
		n.push(a);
		let s = 1 / a;
		o > e - Vo ? s = Ho[o - e + Vo - 1] : o === 0 && (s = 0), r.push(s);
		...
		let h = new wr();
		h.setAttribute("position", new pr(f, 3)), h.setAttribute("uv", new pr(p, 2)), h.setAttribute("faceIndex", new pr(m, 1)), t.push(h), i > Vo && i--;
	}
	return {
		lodPlanes: t,
		sizeLods: n,
...
function is(e, t, n) {
	let r = new Float32Array(Uo), i = new W(0, 1, 0);
	return new qr({
	...
	function r(r) {
		if (r && r.isTexture) {
			...
			if (s || c) {
				...
				if (r.isRenderTargetTexture && r.pmremVersion !== l) return n === null && (n = new es(e)), o = s ? n.fromEquirectangular(r, o) : n.fromCubemap(r, o), o.texture.pmremVersion = r.pmremVersion, t.set(r, o), o.texture;
				if (o !== void 0) return o.texture;
				{
					let l = r.image;
					return s && l && l.height > 0 || c && l && i(l) ? (n === null && (n = new es(e)), o = s ? n.fromEquirectangular(r) : n.fromCubemap(r), o.texture.pmremVersion = r.pmremVersion, t.set(r, o), r.addEventListener("dispose", a), o.texture) : null;
				}
			}
		}
		return r;
...
var hs = /*@__PURE__*/ new It(), gs = /*@__PURE__*/ new ua(1, 1), _s = /*@__PURE__*/ new zt(), vs = /*@__PURE__*/ new Bt(), ys = /*@__PURE__*/ new ni(), bs = [], xs = [], Ss = new Float32Array(16), Cs = new Float32Array(9), ws = new Float32Array(4);
function Ts(e, t, n) {
	let r = e[0];
	if (r <= 0 || r > 0) return e;
	let i = t * n, a = bs[i];
	if (a === void 0 && (a = new Float32Array(i), bs[i] = a), t !== 0) {
		r.toArray(a, 0);
...
function Ns(e, t) {
	...
	if (r === void 0) {
		...
		if (Es(n, r)) return;
		ws.set(r), e.uniformMatrix2fv(this.addr, !1, ws), Ds(n, r);
	}
}
function Ps(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (Es(n, r)) return;
		Cs.set(r), e.uniformMatrix3fv(this.addr, !1, Cs), Ds(n, r);
	}
}
function Fs(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (Es(n, r)) return;
		Ss.set(r), e.uniformMatrix4fv(this.addr, !1, Ss), Ds(n, r);
	}
}
function Is(e, t) {
	let n = this.cache;
...
function Ws(e, t, n) {
	...
	let a;
	this.type === e.SAMPLER_2D_SHADOW ? (gs.compareFunction = 515, a = gs) : a = hs, n.setTexture2D(t || a, i);
}
function Gs(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
...
function Ks(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTextureCube(t || ys, i);
}
function qs(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture2DArray(t || _s, i);
}
function Js(e) {
	switch (e) {
		case 5126: return ks;
		case 35664: return As;
		case 35665: return js;
		case 35666: return Ms;
		case 35674: return Ns;
		case 35675: return Ps;
		case 35676: return Fs;
		case 5124:
		...
		case 36295: return Hs;
		case 36296: return Us;
		case 35678:
		case 36198:
		case 36298:
		case 36306:
...
function Xs(e, t) {
	let n = Ts(t, this.size, 2);
	e.uniform2fv(this.addr, n);
}
function Zs(e, t) {
	let n = Ts(t, this.size, 3);
	e.uniform3fv(this.addr, n);
}
function Qs(e, t) {
	let n = Ts(t, this.size, 4);
...
function ec(e, t) {
	let n = Ts(t, this.size, 9);
	e.uniformMatrix3fv(this.addr, !1, n);
}
function tc(e, t) {
	let n = Ts(t, this.size, 16);
...
function uc(e, t, n) {
	let r = this.cache, i = t.length, a = Os(n, i);
	Es(r, a) || (e.uniform1iv(this.addr, a), Ds(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture2D(t[e] || hs, a[e]);
}
function dc(e, t, n) {
	let r = this.cache, i = t.length, a = Os(n, i);
	Es(r, a) || (e.uniform1iv(this.addr, a), Ds(r, a));
...
function fc(e, t, n) {
	let r = this.cache, i = t.length, a = Os(n, i);
	Es(r, a) || (e.uniform1iv(this.addr, a), Ds(r, a));
	for (let e = 0; e !== i; ++e) n.setTextureCube(t[e] || ys, a[e]);
}
function pc(e, t, n) {
	let r = this.cache, i = t.length, a = Os(n, i);
	Es(r, a) || (e.uniform1iv(this.addr, a), Ds(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || _s, a[e]);
}
function mc(e) {
	switch (e) {
		case 5126: return Ys;
		case 35664: return Xs;
		case 35665: return Zs;
		case 35666: return Qs;
		case 35674: return $s;
		case 35675: return ec;
		case 35676: return tc;
		case 5124:
		case 35670: return nc;
		case 35667:
		case 35671: return rc;
		case 35668:
		case 35672: return ic;
		case 35669:
		case 35673: return ac;
		case 5125: return oc;
		case 36294: return sc;
		case 36295: return cc;
		case 36296: return lc;
		case 35678:
		case 36198:
		case 36298:
		case 36306:
		case 35682: return uc;
		case 35679:
		case 36299:
		case 36307: return dc;
		case 35680:
		case 36300:
		case 36308:
...
function bc(e, t, n) {
	...
	for (vc.lastIndex = 0;;) {
		...
		if (c && (s |= 0), l === void 0 || l === "[" && o + 2 === i) {
			yc(n, l === void 0 ? new hc(s, e, t) : new gc(s, e, t));
			break;
		} else {
			let e = n.map[s];
			e === void 0 && (e = new _c(s), yc(n, e)), n = e;
		}
	}
}
var xc = class {
	constructor(e, t) {
		...
		for (let r = 0; r < n; ++r) {
			...
			bc(n, e.getUniformLocation(t, n.name), this);
		}
	}
	setValue(e, t, n, r) {
		let i = this.map[t];
...
var Ec = /*@__PURE__*/ new G();
function Dc(e) {
	K._getMatrix(Ec, K.workingColorSpace, e);
	let t = `mat3( ${Ec.elements.map((e) => e.toFixed(4))} )`;
...
function Mc() {
	return K.getLuminanceCoefficients(jc), [
		"float luminance( const in vec3 rgb ) {",
		`	const vec3 weights = vec3( ${jc.x.toFixed(4)}, ${jc.y.toFixed(4)}, ${jc.z.toFixed(4)} );`,
		"	return dot( weights, rgb );",
		"}"
	].join("\n");
}
function Nc(e) {
	return [e.extensionClipCullDistance ? "#extension GL_ANGLE_clip_cull_distance : require" : "", e.extensionMultiDraw ? "#extension GL_ANGLE_multi_draw : require" : ""].filter(Ic).join("\n");
}
function Pc(e) {
	let t = [];
	for (let n in e) {
...
var Uc = /#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;
function Wc(e) {
	return e.replace(Uc, Gc);
}
function Gc(e, t, n, r) {
	let i = "";
...
function Qc(e, t, n, r) {
	let i = e.getContext(), a = n.defines, o = n.vertexShader, s = n.fragmentShader, c = qc(n), l = Jc(n), u = Yc(n), d = Xc(n), f = Zc(n), p = Nc(n), m = Pc(a), h = i.createProgram(), g, _, v = n.glslVersion ? "#version " + n.glslVersion + "\n" : "";
	n.isRawShaderMaterial ? (g = [
		...
		n.toneMapping === 0 ? "" : Ac("toneMapping", n.toneMapping),
	...
	function C(t) {
		if (e.debug.checkShaderErrors) {
			...
			if (i.getProgramParameter(h, i.LINK_STATUS) === !1) if (l = !1, typeof e.debug.onShaderError == "function") e.debug.onShaderError(i, h, x, S);
				...
				let e = Oc(i, x, "vertex"), n = Oc(i, S, "fragment");
		...
		i.deleteShader(x), i.deleteShader(S), w = new xc(i, h), T = Fc(i, h);
	}
	let w;
	...
	}, this.type = n.shaderType, this.name = n.shaderName, this.id = wc++, this.cacheKey = t, this.usedTimes = 1, this.program = h, this.vertexShader = x, this.fragmentShader = S, this;
}
var $c = 0, el = class {
	constructor() {
	...
	_getShaderStage(e) {
		...
		return n === void 0 && (n = new tl(e), t.set(e, n)), n;
	}
}, tl = class {
	constructor(e) {
		this.id = $c++, this.code = e, this.usedTimes = 0;
	}
};
function nl(e, t, n, r, i, a, o) {
	let s = new Tn(), c = new el(), l = /* @__PURE__ */ new Set(), u = [], d = i.logarithmicDepthBuffer, f = i.vertexTextures, p = i.precision, m = {
	...
	function g(a, s, u, g, _) {
		...
		a.toneMapped && (A === null || A.isXRRenderTarget === !0) && (ke = e.toneMapping);
		let Ae = {
			shaderID: C,
			shaderType: a.type,
			shaderName: a.name,
			...
			outputColorSpace: A === null ? e.outputColorSpace : A.isXRRenderTarget === !0 ? A.texture.colorSpace : Ie,
			...
			emissiveMapUv: P && h(a.emissiveMap.channel),
			...
			vertexTangents: !!y.attributes.tangent && (se || de),
			vertexColors: a.vertexColors,
			vertexAlphas: a.vertexColors === !0 && !!y.attributes.color && y.attributes.color.itemSize === 4,
			pointsUvs: _.isPoints === !0 && !!y.attributes.uv && (M || Te),
			fog: !!v,
			useFog: a.fog === !0,
			...
			toneMapping: ke,
			decodeVideoTexture: M && a.map.isVideoTexture === !0 && K.getTransfer(a.map.colorSpace) === "srgb",
			decodeVideoTextureEmissive: P && a.emissiveMap.isVideoTexture === !0 && K.getTransfer(a.emissiveMap.colorSpace) === "srgb",
			...
			extensionMultiDraw: (Oe && a.extensions.multiDraw === !0 || ne) && r.has("WEBGL_multi_draw"),
	...
	function x(t, n) {
		...
		return r === void 0 && (r = new Qc(e, n, t, a), u.push(r)), r;
	}
	function S(e) {
		if (--e.usedTimes === 0) {
			let t = u.indexOf(e);
...
function _l(e, t, n) {
	let r = new Hi(), i = new U(), a = new U(), s = new q(), c = new ha({ depthPacking: Pe }), l = new ga(), u = {}, d = n.maxTextureSize, f = {
		0: 1,
		1: 0,
		2: 2
	}, p = new qr({
...
function yl(e, t) {
	...
	function r() {
		...
		return {
			...
			setTest: function(t) {
				t ? P(e.DEPTH_TEST) : le(e.DEPTH_TEST);
			},
			setMask: function(t) {
	...
	function i() {
		...
		return {
			setTest: function(n) {
				t || (n ? P(e.STENCIL_TEST) : le(e.STENCIL_TEST));
			},
			setMask: function(r) {
	...
	let a = new n(), o = new r(), s = new i(), c = /* @__PURE__ */ new WeakMap(), l = /* @__PURE__ */ new WeakMap(), u = {}, d = {}, f = /* @__PURE__ */ new WeakMap(), p = [], m = null, h = !1, g = null, _ = null, v = null, y = null, b = null, x = null, S = null, C = new Y(0, 0, 0), w = 0, T = !1, E = null, D = null, ee = null, O = null, k = null, A = e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS), te = !1, j = 0, ne = e.getParameter(e.VERSION);
	...
	let M = null, N = {}, re = e.getParameter(e.SCISSOR_BOX), ie = e.getParameter(e.VIEWPORT), ae = new q().fromArray(re), oe = new q().fromArray(ie);
	function se(t, n, r, i) {
	...
	function F(t, n) {
		t.side === 2 ? le(e.CULL_FACE) : P(e.CULL_FACE);
		let r = t.side === 1;
		...
		s.setTest(i), i && (s.setMask(t.stencilWriteMask), s.setFunc(t.stencilFunc, t.stencilRef, t.stencilFuncMask), s.setOp(t.stencilFail, t.stencilZFail, t.stencilZPass)), R(t.polygonOffset, t.polygonOffsetFactor, t.polygonOffsetUnits), t.alphaToCoverage === !0 ? P(e.SAMPLE_ALPHA_TO_COVERAGE) : le(e.SAMPLE_ALPHA_TO_COVERAGE);
	}
	function ge(t) {
		E !== t && (t ? e.frontFace(e.CW) : e.frontFace(e.CCW), E = t);
	}
	function I(t) {
		t === 0 ? le(e.CULL_FACE) : (P(e.CULL_FACE), t !== D && (t === 1 ? e.cullFace(e.BACK) : t === 2 ? e.cullFace(e.FRONT) : e.cullFace(e.FRONT_AND_BACK))), D = t;
	}
	function L(t) {
		t !== ee && (te && e.lineWidth(t), ee = t);
	}
	function R(t, n, r) {
		t ? (P(e.POLYGON_OFFSET_FILL), (O !== n || k !== r) && (e.polygonOffset(n, r), O = n, k = r)) : le(e.POLYGON_OFFSET_FILL);
	}
	function _e(t) {
		t ? P(e.SCISSOR_TEST) : le(e.SCISSOR_TEST);
	}
	function z(t) {
...
function bl(e, t, n, f, p, m, h) {
			...
			if (r.isDepthTexture) g = k(r.format === O, r.type), b && (y ? n.texStorage2D(e.TEXTURE_2D, 1, g, d.width, d.height) : n.texImage2D(e.TEXTURE_2D, 0, g, d.width, d.height, 0, f, h, null));
				...
				for (let t = 0, i = v.length; t < i; t++) if (_ = v[t], r.format !== 1023) if (f !== null) if (y) {
					if (x) if (r.layerUpdates.size > 0) {
						let i = Do(_.width, _.height, r.format, r.type);
				...
				if (b && n.texStorage3D(e.TEXTURE_2D_ARRAY, S, g, d.width, d.height, d.depth), x) if (r.layerUpdates.size > 0) {
					let t = Do(d.width, d.height, r.format, r.type);
	...
	function R(t, n, r) {
		if (e.bindRenderbuffer(e.RENDERBUFFER, t), n.depthBuffer) {
			let i = n.depthTexture, a = i && i.isDepthTexture ? i.type : null, o = k(n.stencilBuffer, a), s = n.stencilBuffer ? e.DEPTH_STENCIL_ATTACHMENT : e.DEPTH_ATTACHMENT, c = Ce(n);
			...
			for (let i = 0; i < t.length; i++) {
				let a = t[i], o = m.convert(a.format, a.colorSpace), s = m.convert(a.type), c = ee(a.internalFormat, o, s, a.colorSpace), l = Ce(n);
		...
		if (c || (a.__webglTexture === void 0 && (a.__webglTexture = e.createTexture()), a.__version = r.version, h.memory.textures++), s) {
			...
			if (t.samples > 0 && we(t) === !1) {
				...
				for (let n = 0; n < o.length; n++) {
					...
					let a = m.convert(r.format, r.colorSpace), s = m.convert(r.type), c = ee(r.internalFormat, a, s, r.colorSpace, t.isXRRenderTarget === !0), l = Ce(t);
...
var Sl = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", Cl = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", wl = class {
	...
	constructor(e, t) {
		super();
		let n = this, r = null, i = 1, a = null, o = "local-floor", s = 1, c = null, l = null, u = null, d = null, p = null, m = null, h = typeof XRWebGLBinding < "u", g = new wl(), v = {}, y = t.getContextAttributes(), b = null, x = null, C = [], w = [], T = new U(), E = null, k = new Qr();
		k.viewport = new q();
		let A = new Qr();
		A.viewport = new q();
		let te = [k, A], j = new fo(), ne = null, M = null;
		...
		this.updateCamera = function(e) {
			...
			a.length === 2 ? se(j, k, A) : j.projectionMatrix.copy(k.projectionMatrix), P(e, j, i);
		};
		function P(e, t, n) {
...
}, El = /*@__PURE__*/ new wn(), Dl = /*@__PURE__*/ new J();
function Ol(e, t) {
	function n(e, t) {
	...
	function a(e, r) {
		...
		a && (e.envMap.value = a, El.copy(o), El.x *= -1, El.y *= -1, El.z *= -1, a.isCubeTexture && a.isRenderTargetTexture === !1 && (El.y *= -1, El.z *= -1), e.envMapRotation.value.setFromMatrix4(Dl.makeRotationFromEuler(El)), e.flipEnvMap.value = a.isCubeTexture && a.isRenderTargetTexture === !1 ? -1 : 1, e.reflectivity.value = r.reflectivity, e.ior.value = r.ior, e.refractionRatio.value = r.refractionRatio), r.lightMap && (e.lightMap.value = r.lightMap, e.lightMapIntensity.value = r.lightMapIntensity, n(r.lightMap, e.lightMapTransform)), r.aoMap && (e.aoMap.value = r.aoMap, e.aoMapIntensity.value = r.aoMapIntensity, n(r.aoMap, e.aoMapTransform));
	}
	function o(e, t) {
...
var Al = class {
	constructor(e = {}) {
		...
		let w = 0, T = 0, E = null, D = -1, ee = null, O = new q(), k = new q(), A = null, te = new Y(0), j = 0, ne = t.width, M = t.height, N = 1, re = null, ie = null, ae = new q(0, 0, ne, M), oe = new q(0, 0, ne, M), se = !1, ce = new Hi(), P = !1, le = !1, ue = new J(), de = new W(), fe = new q(), pe = {
			background: null,
			fog: null,
			environment: null,
		...
		this.xr = ze, this.getContext = function() {
			...
			e.isVector4 ? ae.set(e.x, e.y, e.z, e.w) : ae.set(e, t, n, r), R.viewport(O.copy(ae).multiplyScalar(N).round());
		}, this.getScissor = function(e) {
			return e.copy(oe);
		}, this.setScissor = function(e, t, n, r) {
			e.isVector4 ? oe.set(e.x, e.y, e.z, e.w) : oe.set(e, t, n, r), R.scissor(k.copy(oe).multiplyScalar(N).round());
		}, this.getScissorTest = function() {
			return se;
		}, this.setScissorTest = function(e) {
			R.setScissorTest(se = e);
		...
		Ze.setAnimationLoop(Je), typeof self < "u" && Ze.setContext(self), this.setAnimationLoop = function(e) {
			...
			Qe(e, t, 0, S.sortObjects), _.finish(), S.sortObjects === !0 && _.sort(re, ie), me = ze.enabled === !1 || ze.isPresenting === !1 || ze.hasDepthSensing() === !1, me && ke.addToRenderList(_, e), this.info.render.frame++, P === !0 && De.beginShadows();
			let n = v.state.shadowsArray;
			Oe.render(n, e, t), P === !0 && De.endShadows(), this.info.autoReset === !0 && this.info.reset();
			...
			E !== null && T === 0 && (B.updateMultisampleRenderTarget(E), B.updateRenderTargetMipmap(E)), e.isScene === !0 && e.onAfterRender(S, e, t), Pe.resetDefaultState(), D = -1, ee = null, x.pop(), x.length > 0 ? (v = x[x.length - 1], P === !0 && De.setGlobalState(S.clippingPlanes, v.state.camera)) : v = null, b.pop(), _ = b.length > 0 ? b[b.length - 1] : null;
		};
		function Qe(e, t, n, r) {
		...
		function $e(e, t, n, r) {
			...
			v.setupLightsView(n), P === !0 && De.setGlobalState(S.clippingPlanes, n), r && R.viewport(O.copy(r)), i.length > 0 && tt(i, t, n), a.length > 0 && tt(a, t, n), o.length > 0 && tt(o, t, n), R.buffers.depth.setTest(!0), R.buffers.depth.setMask(!0), R.buffers.color.setMask(!0), R.setPolygonOffset(!1);
		}
		function et(e, t, n, r) {
			...
			S.setRenderTarget(a), S.getClearColor(te), j = S.getClearAlpha(), j < 1 && S.setClearColor(16777215, .5), S.clear(), me && ke.render(n);
			let u = S.toneMapping;
			S.toneMapping = 0;
			let p = r.viewport;
			if (r.viewport !== void 0 && (r.viewport = void 0), v.setupLightsView(r), P === !0 && De.setGlobalState(S.clippingPlanes, r), tt(e, n, r), B.updateMultisampleRenderTarget(a), B.updateRenderTargetMipmap(a), I.has("WEBGL_multisampled_render_to_texture") === !1) {
				let e = !1;
				for (let i = 0, a = t.length; i < a; i++) {
		...
		this.setRenderTarget = function(e, t = 0, n = 0) {
			...
			if (n !== 0 && (i = lt), R.bindFramebuffer(F.FRAMEBUFFER, i) && r && R.drawBuffers(e, i), R.viewport(O), R.scissor(k), R.setScissorTest(A), a) {
...
var Ml = class extends za {
	...
	parse(e, t, n, r) {
		...
		else if (e instanceof ArrayBuffer) if (s.decode(new Uint8Array(e, 0, 4)) === Ql) {
			try {
				a[Q.KHR_BINARY_GLTF] = new tu(e);
			} catch (e) {
				r && r(e);
				return;
			}
...
var Q = {
	...
	_loadLight(e) {
		...
		switch (a.type) {
			case "directional":
				...
				break;
			case "point":
				o = new io(s), o.distance = c;
				break;
			case "spot":
				o = new $a(s), o.distance = c, a.spot = a.spot || {}, a.spot.innerConeAngle = a.spot.innerConeAngle === void 0 ? 0 : a.spot.innerConeAngle, a.spot.outerConeAngle = a.spot.outerConeAngle === void 0 ? Math.PI / 4 : a.spot.outerConeAngle, o.angle = a.spot.outerConeAngle, o.penumbra = 1 - a.spot.innerConeAngle / a.spot.outerConeAngle, o.target.position.set(0, 0, -1), o.add(o.target);
				break;
			default: throw Error("THREE.GLTFLoader: Unexpected light type: " + a.type);
		}
		return o.position.set(0, 0, 0), yu(o, a), a.intensity !== void 0 && (o.intensity = a.intensity), o.name = t.createUniqueName(a.name || "light_" + e), r = Promise.resolve(o), t.cache.add(n, r), r;
	}
	getDependency(e, t) {
	...
	getMaterialType(e) {
		...
		return !t.extensions || !t.extensions[this.name] ? null : ma;
	}
	extendMaterialParams(e, t) {
	...
	createNodeMesh(e) {
		...
		for (let e of r.primitives) if (e.mode !== cu.TRIANGLES && e.mode !== cu.TRIANGLE_STRIP && e.mode !== cu.TRIANGLE_FAN && e.mode !== void 0) return null;
	...
	constructor(e) {
		...
		let t = new DataView(e, 0, $l), n = new TextDecoder();
		if (this.header = {
			magic: n.decode(new Uint8Array(e.slice(0, 4))),
			version: t.getUint32(4, !0),
			length: t.getUint32(8, !0)
		}, this.header.magic !== Ql) throw Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");
		if (this.header.version < 2) throw Error("THREE.GLTFLoader: Legacy binary file detected.");
		let r = this.header.length - $l, i = new DataView(e, $l), a = 0;
		for (; a < r;) {
			let t = i.getUint32(a, !0);
			a += 4;
			let r = i.getUint32(a, !0);
			if (a += 4, r === eu.JSON) {
				let r = new Uint8Array(e, $l + a, t);
	...
	decodePrimitive(e, t) {
		...
		for (let e in a) {
			let t = pu[e] || e.toLowerCase();
			o[t] = a[e];
		}
		for (let t in e.attributes) {
			let r = pu[t] || t.toLowerCase();
			if (a[t] !== void 0) {
				let i = n.accessors[e.attributes[t]];
				c[r] = lu[i.componentType].name, s[r] = i.normalized === !0;
			}
		}
...
}, ou = new mt(), su = class extends au {
	interpolate_(e, t, n, r) {
		let i = super.interpolate_(e, t, n, r);
		return ou.fromArray(i).normalize().toArray(i), i;
	}
}, cu = {
	FLOAT: 5126,
	FLOAT_MAT3: 35675,
...
function _u(e) {
	return e.DefaultMaterial === void 0 && (e.DefaultMaterial = new pa({
		color: 16777215,
		emissive: 0,
		metalness: 1,
		roughness: 1,
...
function Su(e) {
	...
	if (t = n ? "draco:" + n.bufferView + ":" + n.indices + ":" + Cu(n.attributes) : e.indices + ":" + Cu(e.attributes) + ":" + e.mode, e.targets !== void 0) for (let n = 0, r = e.targets.length; n < r; n++) t += ":" + Cu(e.targets[n]);
	return t;
}
function Cu(e) {
...
var Eu = new J(), Du = class {
	constructor(e = {}, t = {}) {
		this.json = e, this.extensions = {}, this.plugins = {}, this.options = t, this.cache = new Nl(), this.associations = /* @__PURE__ */ new Map(), this.primitiveCache = {}, this.nodeCache = {}, this.meshCache = {
			refs: {},
			uses: {}
		}, this.cameraCache = {
			refs: {},
		...
		typeof createImageBitmap > "u" || n && r < 17 || i && a < 98 ? this.textureLoader = new Ga(this.options.manager) : this.textureLoader = new uo(this.options.manager), this.textureLoader.setCrossOrigin(this.options.crossOrigin), this.textureLoader.setRequestHeader(this.options.requestHeader), this.fileLoader = new Ha(this.options.manager), this.fileLoader.setResponseType("arraybuffer"), this.options.crossOrigin === "use-credentials" && this.fileLoader.setWithCredentials(!0);
	}
	setExtensions(e) {
		this.extensions = e;
	}
	...
	parse(e, t) {
		...
		this.cache.removeAll(), this.nodeCache = {}, this._invokeAll(function(e) {
			...
			return vu(i, a, r), yu(a, r), Promise.all(n._invokeAll(function(e) {
	...
	loadAccessor(e) {
		...
		if (r.bufferView === void 0 && r.sparse === void 0) {
			let e = fu[r.type], t = lu[r.componentType], n = r.normalized === !0, i = new t(r.count * e);
		...
		return r.bufferView === void 0 ? i.push(null) : i.push(this.getDependency("bufferView", r.bufferView)), r.sparse !== void 0 && (i.push(this.getDependency("bufferView", r.sparse.indices.bufferView)), i.push(this.getDependency("bufferView", r.sparse.values.bufferView))), Promise.all(i).then(function(e) {
			let i = e[0], a = fu[r.type], o = lu[r.componentType], s = o.BYTES_PER_ELEMENT, c = s * a, l = r.byteOffset || 0, u = r.bufferView === void 0 ? void 0 : n.bufferViews[r.bufferView].byteStride, d = r.normalized === !0, f, p;
			if (u && u !== c) {
			...
			if (r.sparse !== void 0) {
				let t = fu.SCALAR, n = lu[r.sparse.indices.componentType], s = r.sparse.indices.byteOffset || 0, c = r.sparse.values.byteOffset || 0, l = new n(e[1], s, r.sparse.count * t), u = new o(e[2], c, r.sparse.count * a);
	...
	loadTextureImage(e, t, n) {
		...
		let c = this.loadImageSource(t, n).then(function(t) {
			...
			return t.magFilter = uu[n.magFilter] || 1006, t.minFilter = uu[n.minFilter] || 1008, t.wrapS = du[n.wrapS] || 1e3, t.wrapT = du[n.wrapT] || 1e3, t.generateMipmaps = !t.isCompressedTexture && t.minFilter !== 1003 && t.minFilter !== 1006, r.associations.set(t, { textures: e }), t;
		}).catch(function() {
			return null;
		});
	...
	loadImageSource(e, t) {
		...
		let l = Promise.resolve(s).then(function(e) {
			...
			return c === !0 && o.revokeObjectURL(s), yu(e, a), e.userData.mimeType = a.mimeType || Tu(a.uri), e;
		}).catch(function(e) {
	...
	loadMaterial(e) {
		...
		let l = i.alphaMode || gu.OPAQUE;
		if (l === gu.BLEND ? (o.transparent = !0, o.depthWrite = !1) : (o.transparent = !1, l === gu.MASK && (o.alphaTest = i.alphaCutoff === void 0 ? .5 : i.alphaCutoff)), i.normalTexture !== void 0 && a !== lr && (c.push(t.assignTexture(o, "normalMap", i.normalTexture)), o.normalScale = new U(1, 1), i.normalTexture.scale !== void 0)) {
		...
		return i.emissiveTexture !== void 0 && a !== lr && c.push(t.assignTexture(o, "emissiveMap", i.emissiveTexture, Fe)), Promise.all(c).then(function() {
			let n = new a(o);
			return i.name && (n.name = i.name), yu(n, i), t.associations.set(n, { materials: e }), i.extensions && vu(r, n, i), n;
		});
	}
	createUniqueName(e) {
		let t = wo.sanitizeNodeName(e || "");
	...
	loadGeometries(e) {
		...
		for (let n = 0, o = e.length; n < o; n++) {
			let o = e[n], s = Su(o), c = r[s];
			if (c) a.push(c.promise);
			else {
				let e;
				e = o.extensions && o.extensions[Q.KHR_DRACO_MESH_COMPRESSION] ? i(o) : ku(new wr(), o, t), r[s] = {
					primitive: o,
					promise: e
				}, a.push(e);
			}
	...
	loadMesh(e) {
		...
		for (let e = 0, t = a.length; e < t; e++) {
			let t = a[e].material === void 0 ? _u(this.cache) : this.getDependency("material", a[e].material);
			o.push(t);
		}
		return o.push(t.loadGeometries(a)), Promise.all(o).then(function(n) {
			...
			for (let n = 0, l = s.length; n < l; n++) {
				...
				if (u.mode === cu.TRIANGLES || u.mode === cu.TRIANGLE_STRIP || u.mode === cu.TRIANGLE_FAN || u.mode === void 0) d = i.isSkinnedMesh === !0 ? new bi(l, f) : new Ir(l, f), d.isSkinnedMesh === !0 && d.normalizeSkinWeights(), u.mode === cu.TRIANGLE_STRIP ? d.geometry = jl(d.geometry, 1) : u.mode === cu.TRIANGLE_FAN && (d.geometry = jl(d.geometry, 2));
				else if (u.mode === cu.LINES) d = new ta(l, f);
				else if (u.mode === cu.LINE_STRIP) d = new Zi(l, f);
				else if (u.mode === cu.LINE_LOOP) d = new na(l, f);
				else if (u.mode === cu.POINTS) d = new ca(l, f);
				else throw Error("THREE.GLTFLoader: Primitive mode unsupported: " + u.mode);
				Object.keys(d.geometry.morphAttributes).length > 0 && xu(d, i), d.name = t.createUniqueName(i.name || "mesh_" + e), yu(d, i), u.extensions && vu(r, d, u), t.assignFinalMaterial(d), c.push(d);
			}
			for (let n = 0, r = c.length; n < r; n++) t.associations.set(c[n], {
				meshes: e,
				primitives: n
			});
			if (c.length === 1) return i.extensions && vu(r, c[0], i), c[0];
			let l = new ii();
			i.extensions && vu(r, l, i), t.associations.set(l, { meshes: e });
	...
	loadCamera(e) {
		...
		return n.type === "perspective" ? t = new Qr(pt.radToDeg(r.yfov), r.aspectRatio || 1, r.znear || 1, r.zfar || 2e6) : n.type === "orthographic" && (t = new ao(-r.xmag, r.xmag, r.ymag, -r.ymag, r.znear, r.zfar)), n.name && (t.name = this.createUniqueName(n.name)), yu(t, n), Promise.resolve(t);
	}
	loadSkin(e) {
	...
	_loadNodeShallow(e) {
		...
		return s && o.push(s), i.camera !== void 0 && o.push(r.getDependency("camera", i.camera).then(function(e) {
			...
			if (i.name && (o.userData.name = i.name, o.name = a), yu(o, i), i.extensions && vu(n, o, i), i.matrix !== void 0) {
				let e = new J();
	...
	loadScene(e) {
		...
		n.name && (i.name = r.createUniqueName(n.name)), yu(i, n), n.extensions && vu(t, i, n);
		let a = n.nodes || [], o = [];
	...
	_createAnimationTracks(e, t, n, r, i) {
		...
		mu[i.path] === mu.weights ? e.traverse(function(e) {
		...
		let l = r.interpolation === void 0 ? De : hu[r.interpolation], u = this._getArrayFromAccessor(n);
		for (let e = 0, n = s.length; e < n; e++) {
			let n = new c(s[e] + "." + mu[i.path], t.array, u, l);
	...
	_getArrayFromAccessor(e) {
		let t = e.array;
		if (e.normalized) {
			let e = wu(t.constructor), n = new Float32Array(t.length);
	...
	_createCubicSplineTrackInterpolant(e) {
		e.createInterpolant = function(e) {
			return new (this instanceof ja ? su : au)(this.times, this.values, this.getValueSize() / 3, e);
...
function ku(e, t, n) {
	...
	return K.workingColorSpace !== "srgb-linear" && "COLOR_0" in r && console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${K.workingColorSpace}" not supported.`), yu(e, t), Ou(e, t, n), Promise.all(i).then(function() {
		return t.targets === void 0 ? e : bu(e, t.targets, n);
	});
}
//#endregion
//#region node_modules/.pnpm/three@0.180.0/node_modules/three/examples/jsm/controls/OrbitControls.js
var Au = { type: "change" }, ju = { type: "start" }, Mu = { type: "end" }, Nu = new mn(), Pu = new Ri(), Fu = Math.cos(70 * pt.DEG2RAD), Iu = new W(), Lu = 2 * Math.PI, $ = {
	NONE: -1,
	ROTATE: 0,
	DOLLY: 1,
	PAN: 2,
	...
	reset() {
		this.target.copy(this.target0), this.object.position.copy(this.position0), this.object.zoom = this.zoom0, this.object.updateProjectionMatrix(), this.dispatchEvent(Au), this.update(), this.state = $.NONE;
	}
	update(e = null) {
		let t = this.object.position;
		Iu.copy(t).sub(this.target), Iu.applyQuaternion(this._quat), this._spherical.setFromVector3(Iu), this.autoRotate && this.state === $.NONE && this._rotateLeft(this._getAutoRotationAngle(e)), this.enableDamping ? (this._spherical.theta += this._sphericalDelta.theta * this.dampingFactor, this._spherical.phi += this._sphericalDelta.phi * this.dampingFactor) : (this._spherical.theta += this._sphericalDelta.theta, this._spherical.phi += this._sphericalDelta.phi);
		...
		if (Iu.setFromSpherical(this._spherical), Iu.applyQuaternion(this._quatInverse), t.copy(this.target).add(Iu), this.object.lookAt(this.target), this.enableDamping === !0 ? (this._sphericalDelta.theta *= 1 - this.dampingFactor, this._sphericalDelta.phi *= 1 - this.dampingFactor, this._panOffset.multiplyScalar(1 - this.dampingFactor)) : (this._sphericalDelta.set(0, 0, 0), this._panOffset.set(0, 0, 0)), this.zoomToCursor && this._performCursorZoom) {
			let e = null;
			if (this.object.isPerspectiveCamera) {
				...
				r.unproject(this.object), this.object.position.sub(r).add(t), this.object.updateMatrixWorld(), e = Iu.length();
			...
			e !== null && (this.screenSpacePanning ? this.target.set(0, 0, -1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position) : (Nu.origin.copy(this.object.position), Nu.direction.set(0, 0, -1).transformDirection(this.object.matrix), Math.abs(this.object.up.dot(Nu.direction)) < Fu ? this.object.lookAt(this.target) : (Pu.setFromNormalAndCoplanarPoint(this.object.up, this.target), Nu.intersectPlane(Pu, this.target))));
		} else if (this.object.isOrthographicCamera) {
		...
		return this._scale = 1, this._performCursorZoom = !1, i || this._lastPosition.distanceToSquared(this.object.position) > Ru || 8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > Ru || this._lastTargetPosition.distanceToSquared(this.target) > Ru ? (this.dispatchEvent(Au), this._lastPosition.copy(this.object.position), this._lastQuaternion.copy(this.object.quaternion), this._lastTargetPosition.copy(this.target), !0) : !1;
	}
	_getAutoRotationAngle(e) {
		return e === null ? Lu / 60 / 60 * this.autoRotateSpeed : Lu / 60 * this.autoRotateSpeed * e;
	}
	_getZoomScale(e) {
		let t = Math.abs(e * .01);
	...
	_panLeft(e, t) {
		Iu.setFromMatrixColumn(t, 0), Iu.multiplyScalar(-e), this._panOffset.add(Iu);
	}
	_panUp(e, t) {
		this.screenSpacePanning === !0 ? Iu.setFromMatrixColumn(t, 1) : (Iu.setFromMatrixColumn(t, 0), Iu.crossVectors(this.object.up, Iu)), Iu.multiplyScalar(e), this._panOffset.add(Iu);
	}
	_pan(e, t) {
		let n = this.domElement;
		if (this.object.isPerspectiveCamera) {
			let r = this.object.position;
			Iu.copy(r).sub(this.target);
			let i = Iu.length();
	...
	_handleMouseMoveRotate(e) {
		...
		this._rotateLeft(Lu * this._rotateDelta.x / t.clientHeight), this._rotateUp(Lu * this._rotateDelta.y / t.clientHeight), this._rotateStart.copy(this._rotateEnd), this.update();
	}
	...
	_handleKeyDown(e) {
		...
		switch (e.code) {
			case this.keys.UP:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateUp(Lu * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(0, this.keyPanSpeed), t = !0;
				break;
			case this.keys.BOTTOM:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateUp(-Lu * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(0, -this.keyPanSpeed), t = !0;
				break;
			case this.keys.LEFT:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateLeft(Lu * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(this.keyPanSpeed, 0), t = !0;
				break;
	...
	_handleTouchMoveRotate(e) {
		...
		let t = this.domElement;
		this._rotateLeft(Lu * this._rotateDelta.x / t.clientHeight), this._rotateUp(Lu * this._rotateDelta.y / t.clientHeight), this._rotateStart.copy(this._rotateEnd);
	}
...
function Hu(e) {
	switch (this._removePointer(e), this._pointers.length) {
		case 0:
			this.domElement.releasePointerCapture(e.pointerId), this.domElement.removeEventListener("pointermove", this._onPointerMove), this.domElement.removeEventListener("pointerup", this._onPointerUp), this.dispatchEvent(Mu), this.state = $.NONE;
			break;
		case 1:
...
function Uu(t) {
	...
	this.state !== $.NONE && this.dispatchEvent(ju);
}
function Wu(e) {
	switch (this.state) {
		case $.ROTATE:
...
function Gu(e) {
	this.enabled === !1 || this.enableZoom === !1 || this.state !== $.NONE || (e.preventDefault(), this.dispatchEvent(ju), this._handleMouseWheel(this._customWheelEvent(e)), this.dispatchEvent(Mu));
}
function Ku(e) {
...
//#endregion
//#region src/landing/system-assets-preview.ts
var Qu = document.querySelector("#asset-view"), $u = document.querySelector("#asset-status"), ed = new Al({
	antialias: !0,
	alpha: !0
});
ed.setPixelRatio(Math.min(window.devicePixelRatio, 2)), ed.toneMapping = 4, Qu.append(ed.domElement), ed.domElement.setAttribute("aria-label", "3D asset preview. Drag to rotate and scroll to zoom.");
var td = new si();
td.add(new qa("#ffffff", "#b3aca1", 2));
var nd = new so("#ffffff", 3);
nd.position.set(-3, 6, 4), td.add(nd);
var rd = new Qr(35, 1, .01, 100), id = new zu(rd, ed.domElement);
id.enablePan = !1;
var ad = () => ed.render(td, rd);
id.addEventListener("change", ad);
var od = new Ml(), sd, cd = 0;
function ld(e) {
	e.traverse((e) => {
		if (e instanceof Ir) {
			e.geometry.dispose();
			for (let t of Array.isArray(e.material) ? e.material : [e.material]) t.dispose();
		}
	});
}
async function ud(e) {
	let t = ++cd;
	$u.textContent = `Loading ${e.dataset.label}…`;
	try {
		let { scene: n } = await od.loadAsync(`/landing-assets/system-3d/${e.dataset.asset}.glb`);
		if (t !== cd) {
			ld(n);
			return;
		}
		sd && (td.remove(sd), ld(sd)), sd = n, td.add(n);
		let r = new Vt().setFromObject(n), i = r.getCenter(new W()), a = r.getSize(new W()).length();
		rd.position.copy(i).add(new W(.7, 1.5, 1.6).normalize().multiplyScalar(a * 1.65)), id.target.copy(i), id.minDistance = a * .6, id.maxDistance = a * 4, id.update(), document.querySelectorAll("[data-asset]").forEach((t) => t.setAttribute("aria-pressed", String(t === e))), $u.textContent = `${e.dataset.label} · Drag to rotate · Scroll to zoom`, ad();
	} catch {
		t === cd && ($u.textContent = "Could not load this asset. Select it again to retry.");
	}
}
var dd = new ResizeObserver(() => {
	let { width: e, height: t } = Qu.getBoundingClientRect();
	ed.setSize(e, t), rd.aspect = e / t, rd.updateProjectionMatrix(), ad();
});
dd.observe(Qu);
var fd = [...document.querySelectorAll("[data-asset]")];
fd.forEach((e) => e.addEventListener("click", () => void ud(e))), ud(fd[0]), window.addEventListener("pagehide", () => {
	cd++, sd && ld(sd), dd.disconnect(), id.dispose(), ed.dispose();
}, { once: !0 });
//#endregion
