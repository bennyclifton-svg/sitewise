...
const previewDraft: DraftArtifact = {
  ...
  content_markdown: [
    ...
    "## Facts",
    "",
    "- This preview demonstrates the SiteWise cockpit shell without requiring the backend project catalog.",
    "- The real Create PMP workflow remains backend-owned and project-scoped.",
    "",
    "## Assumptions",
    "",
    "- Project evidence, platform knowledge, and workflow state will be supplied by the SiteWise API once the backend is running.",
    "",
